...
var app=angular.module("hrsystem",["ngRoute","chart.js"]);app.config(["ChartJsProvider",function(t){t.setOptions({chartColors:["#FF5252","#FF8A80"],responsive:!1}),t.setOptions("line",{showLines:!1})}]),app.config(function(t){t.when("/",{templateUrl:"js/templates/dashboard.html",controller:"dashboardCtrl"}).when("/employees",{templateUrl:"js/templates/employees.html",controller:"emploCtrl"}).when("/jobs",{templateUrl:"js/templates/jobs.html",controller:"jobsCtrl"}).when("/holiday",{templateUrl:"js/templates/holiday.html",controller:"holidayCtrl"}).when("/attendance",{templateUrl:"js/templates/attendance.html",controller:"attCtrl"}).otherwise({redirectTo:"/"})}),app.controller("attCtrl",function(t){}),app.controller("jobsCtrl",function(t){}),app.controller("holidayCtrl",function(t){});
app.controller("attCtrl",["$scope",function(a){a.cp1={cities:["Kraków","Warszawa","Łódź","Sopot","Gdańsk","Gdynia","Szczecin"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]},a.cp2={cities:["January","February","March","April","May","June","July"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]}}]);
app.controller("dashboardCtrl",["$scope","$timeout",function(a,r){a.cp1={cities:["Kraków","Warszawa","Łódź","Sopot","Gdańsk","Gdynia","Szczecin"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]},a.cp2={cities:["January","February","March","April","May","June","July"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]},a.cp3={cities:["January","February","March","April","May","June","July"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]],datasetOverride:[{label:"Bar chart",borderWidth:1,type:"bar"},{label:"Line chart",borderWidth:3,hoverBackgroundColor:"rgba(255,99,132,0.4)",hoverBorderColor:"rgba(255,99,132,1)",type:"line"}]},a.cp4={labels:["Download Sales","In-Store Sales","Mail-Order Sales","Tele Sales","Corporate Sales"],data:[300,500,100,40,120],type:"polarArea",toggle:function(){a.cp4.type="polarArea"===a.cp4.type?"pie":"polarArea"}}}]);
app.controller("emploCtrl",function(e){e.employees=[{name:"John",lastname:"Doe",mail:"joh@dep.com",dep:"PM"},{name:"Steva",lastname:"Dunkin",mail:"s.dunkin@dep.com",dep:"Engineering"},{name:"Emil",lastname:"Smith",mail:"e.smith@dep.com",dep:"Engineering"},{name:"Bob",lastname:"Cary",mail:"b.cary@dep.com",dep:"Engineering"},{name:"Anett",lastname:"Trebiem",mail:"a.trebiem@dep.com",dep:"PM"},{name:"Rob",lastname:"Meni",mail:"r.meni@dep.com",dep:"HR"},{name:"Kate",lastname:"Dubmble",mail:"k.dubmle@dep.com",dep:"HR"}]});
app.factory("fetchData",["$http",function(t){}]);