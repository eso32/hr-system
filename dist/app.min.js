...
var app=angular.module("hrsystem",["ngRoute","chart.js","ngAnimate"]);app.config(["ChartJsProvider",function(t){t.setOptions({chartColors:["#FF5252","#FF8A80"],responsive:!1}),t.setOptions("line",{showLines:!1})}]),app.config(function(t){t.when("/",{templateUrl:"js/templates/dashboard.html",controller:"dashboardCtrl"}).when("/employees",{templateUrl:"js/templates/employees.html",controller:"emploCtrl"}).when("/jobs",{templateUrl:"js/templates/jobs.html",controller:"jobsCtrl"}).when("/holiday",{templateUrl:"js/templates/holiday.html",controller:"holidayCtrl"}).when("/attendance",{templateUrl:"js/templates/attendance.html",controller:"attCtrl"}).otherwise({redirectTo:"/"})}),app.controller("attCtrl",function(t){}),app.controller("holidayCtrl",function(t){});
app.controller("attCtrl",["$scope",function(a){a.options={responsive:!0,legend:{display:!0,labels:{fontColor:"rgb(255, 99, 132)"}}},a.cp1={cities:["Kraków","Warszawa","Łódź","Sopot","Gdańsk","Gdynia","Szczecin"],try:["2016","2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]},a.cp2={cities:["January","February","March","April","May","June","July"],try:["2016","2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]}}]);
app.controller("dashboardCtrl",["$scope","$timeout",function(e,r){e.options={responsive:!0,scales:{yAxes:[{ticks:{min:0}}]}},e.cp1={cities:["PContr","FrontEnd","PM","Engineer"],try:["V 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[6,7,3,2]]},e.cp2={cities:["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII"],try:["2016","2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[10,2,5,3,2,1,3,2,3,6,13,12],[8,4,7,11,2,4]]},e.cp3={cities:["2013","2014","2015","2016","2017"],try:["New employees","Cumulated number"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[2,3,2,1,5],[2,5,7,8,13]],datasetOverride:[{label:"New employees",borderWidth:1,type:"bar"},{label:"Cumulated number",borderWidth:3,hoverBackgroundColor:"rgba(255,99,132,0.4)",hoverBorderColor:"rgba(255,99,132,1)",type:"line"}]},e.cp4={labels:["PM","Engineering","HR","Administration","3'rd parties"],data:[13,7,12,4,8],type:"pie",toggle:function(){e.cp4.type="polarArea"===e.cp4.type?"pie":"polarArea"},options:{responsive:!0},colors:["#45b7cd","#A0CC14","#ff6384","#ff8e72","#1252B2","#FF3419"]}}]);
app.controller("emploCtrl",function(t,e){t.getData=function(){return document.getElementById("indicator").innerHTML="Refreshing data... Wait...",e({method:"GET",url:"database.json",headers:{"Content-Type":"application/json"}}).then(function(e){var n=new Date,o=n.getHours(),a=n.getMinutes();t.employees=e.data,document.getElementById("indicator").innerHTML="Last update on "+o+":"+a},function(t){document.getElementById("indicator").innerHTML="Error occured "+t.status,console.log("Error occured "+t.status)})},t.getData()});
app.controller("jobsCtrl",function(n,o){o.then(function(o){n.jobs=o})});
app.factory("fetchJobs",function(o){return o({method:"GET",url:"jobs.json",headers:{"Content-Type":"application/json"}}).then(function(o){return o.data},function(o){console.log("Error occured "+o.status)})});