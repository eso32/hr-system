...
var app=angular.module("hrsystem",["ngRoute","chart.js"]);app.config(["ChartJsProvider",function(e){e.setOptions({chartColors:["#FF5252","#FF8A80"],responsive:!1}),e.setOptions("line",{showLines:!1})}]),app.config(function(e){e.when("/",{templateUrl:"js/templates/dashboard.html",controller:"dashboardCtrl"}).when("/employees",{templateUrl:"js/templates/employees.html",controller:"emploCtrl"}).when("/jobs",{templateUrl:"js/templates/jobs.html",controller:"jobsCtrl"}).when("/holiday",{templateUrl:"js/templates/holiday.html",controller:"holidayCtrl"}).when("/attendance",{templateUrl:"js/templates/attendance.html",controller:"attCtrl"}).otherwise({redirectTo:"/"})}),app.controller("dashboardCtrl",["$scope","$timeout",function(e,t){e.cp1={cities:["Kraków","Warszawa","Łódź","Sopot","Gdańsk","Gdynia","Szczecin"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]},e.cp2={cities:["January","February","March","April","May","June","July"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]]},e.cp3={cities:["January","February","March","April","May","June","July"],try:["V 2017","VI 2017"],colors:["#45b7cd","#ff6384","#ff8e72"],data:[[65,59,80,81,56,55,40],[28,48,40,19,86,27,90]],datasetOverride:[{label:"Bar chart",borderWidth:1,type:"bar"},{label:"Line chart",borderWidth:3,hoverBackgroundColor:"rgba(255,99,132,0.4)",hoverBorderColor:"rgba(255,99,132,1)",type:"line"}]},e.cp4={labels:["Download Sales","In-Store Sales","Mail-Order Sales","Tele Sales","Corporate Sales"],data:[300,500,100,40,120],type:"polarArea",toggle:function(){e.cp4.type="polarArea"===e.cp4.type?"pie":"polarArea"}}}]),app.controller("attCtrl",function(e){}),app.controller("emploCtrl",function(e){}),app.controller("jobsCtrl",function(e){}),app.controller("holidayCtrl",function(e){}),app.controller("attCtrl",function(e){});